$(document).ready(function() {
    ...
    // Generating slides
    let seiten = ['0001', 'fgds', 'New s']; // Change number of slides in CSS also
    ...
    let generateSlide = function(wert) {
        ...
        // const seitenZahl = seiten[wert]

        const $slide =
            $(`<div data-target="${numSlide}" class="slide slide--${numSlide}">
							<div class="slide__darkbg slide--${numSlide}__darkbg" style="background:url(zphere_Doku_pages-to-jpg-${seiten[wert]}.jpg) center center no-repeat; background-size: auto 100vh"  ></div>
